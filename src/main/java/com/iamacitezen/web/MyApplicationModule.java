...
public class MyApplicationModule extends AbstractModule {
    ...
    protected void configure() {
        ...
        Configuration conf = Configuration.getDefaults()
          .add(RESOURCE_PATH, "com.iamacitezen.web")
          .add(VIEW_COMPONENT_ROOT_PACKAGE, "com.iamacitezen.web.web.views")
          .add(RELOADABLE_CLASSES.includedPackage("com.iamacitezen.web.web.components"))
